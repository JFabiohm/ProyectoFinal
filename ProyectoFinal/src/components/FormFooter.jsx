                ...
                <Container>
                    <Row className="mb-4">
                        <Col md={4} className="text-center text-md-left mb-3 mb-md-0">
                            <h5>Información</h5>
                            <p>Si quieres saber más de nosotros o de nuestros productos, por favor comunícate por medio de nuestras redes sociales.</p>
                        </Col>
                        <Col md={4} className="text-center text-md-left mb-3 mb-md-0">
                            <h5>Enlaces</h5>
                            <ul className="list-unstyled">
                                <li><Link as={Link} to="/Home" className="text-white">Home</Link></li>
                                <li><Link as={Link} to="/AboutUs" className="text-white">About Us</Link></li>
                                <li><Link as={Link} to="/Home" className="text-white"></Link></li>
                            </ul>
                        </Col>
                        <Col md={4} className="text-center">
                            ...
                            <Row className="justify-content-center">
                                <Col xs="auto" className="footer-icon-col mb-3">
                                    <a href="https://wa.me/+50686735928" target="_blank" rel="noopener noreferrer" className="footer-icon" id="whatsapp">
                                ...
                                <Col xs="auto" className="footer-icon-col mb-3">
                                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="footer-icon" id="facebook">
                    ...
                    <Row>
                        <Col className="text-center">
                            <p>&copy; {new Date().getFullYear()} Indi Cake. Todos los derechos reservados.</p>
                        </Col>
                    </Row>
                </Container>
            </footer>
